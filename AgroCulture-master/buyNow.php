<?php
    ...
    // Check if 'pid' is set in the URL before accessing it
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if ($result) {
            // Clear the cart session after successful transaction
            unset($_SESSION['cart']);  // or $_SESSION['cart'] = array(); to reset the cart to an empty array
